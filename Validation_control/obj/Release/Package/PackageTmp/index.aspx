...
<body>
    <form id="form1" runat="server">
        ...
        <asp:RangeValidator ID="RangeValidator1" runat="server" ControlToValidate="Calendar1" Display="Dynamic" ErrorMessage="Age must be in between 18 to 45" ForeColor="Red" Type="Date">Age must be in between 18 to 45</asp:RangeValidator>
        <br />
        <br />
        Country&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
