...
<body>
    <form id="form1" runat="server" aria-atomic="False">
        User ID&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:TextBox ID="TextBox1" runat="server" OnTextChanged="TextBox1_TextChanged" style="margin-left: 26px" Width="149px" BorderColor="#0066FF"></asp:TextBox>
        ...
        <br />
        Password&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:TextBox ID="TextBox2" runat="server" style="margin-left: 26px" Width="149px" BorderColor="#0066FF"></asp:TextBox>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="TextBox2" Display="Dynamic" ErrorMessage="Need to enter the Password" ForeColor="Red" SetFocusOnError="True">*</asp:RequiredFieldValidator>
        ...
        <br />
        <br />
        Confirm Password<asp:TextBox ID="TextBox3" runat="server" style="margin-left: 26px" Width="149px" BorderColor="#0066FF"></asp:TextBox>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="TextBox3" Display="Dynamic" ErrorMessage="need to enter confirm password" ForeColor="Red">*</asp:RequiredFieldValidator>
        ...
        <br />
        Email Id&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:TextBox ID="TextBox4" runat="server" style="margin-left: 26px" Width="149px" BorderColor="#0066FF"></asp:TextBox>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="TextBox4" Display="Dynamic" ErrorMessage="Email need to entered" ForeColor="Red">*</asp:RequiredFieldValidator>
        ...
        <br />
        Mobile User&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:TextBox ID="TextBox5" runat="server" style="margin-left: 26px" Width="149px" BorderColor="#0066FF"></asp:TextBox>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="TextBox5" ErrorMessage="need to enter the mobile number" ForeColor="Red">*</asp:RequiredFieldValidator>
        ...
        <br />
        DOB&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:TextBox ID="TextBox6" runat="server" style="margin-left: 26px" Width="149px" BorderColor="#0066FF"></asp:TextBox>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="TextBox6" Display="Dynamic" ErrorMessage="Need to enter the DOB" ForeColor="Red">*</asp:RequiredFieldValidator>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="Button1" runat="server" Text="Button" BackColor="#0000CC" BorderColor="Black" BorderStyle="Double" ForeColor="Black" />
        <br />
    </form>
</body>
</html>
